    ...
    return (
        <div>
            ...
            <div className='navegationcel '>
                <a className="btn fix-networks" href="#home" >
                    <i class="bi bi bi-house-fill icons-navegation" ></i>
                </a>
                <a className="btn fix-networks" href="#about"><i class="bi bi-person-fill icons-navegation" ></i></a>
                <a className="btn fix-networks" href="#projects"><i class="bi bi-briefcase-fill icons-navegation" ></i></a>
                <a className="btn fix-networks" href="#skills"><i class="bi bi-binoculars-fill icons-navegation" ></i></a>
                <a className="btn fix-networks" href="#form"><i class="bi bi-envelope-open-fill icons-navegation" ></i></a>
            </div>
        </div>
    );
}
